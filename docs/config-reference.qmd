...
Optimizer configuration for AdamW or Muon with linear warmup and cosine decay. Contains 12 fields.
...
```yaml
muon_consistent_rms: float | null = 0.2
```

Muon RMS scaling factor. Set to `null` to disable consistent RMS scaling.
