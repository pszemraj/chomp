...
**optim** (12 fields): [`name`](#optim.name), [`lr`](#optim.lr), [`muon_lr_scale`](#optim.muon_lr_scale), [`weight_decay`](#optim.weight_decay), [`grad_clip_norm`](#optim.grad_clip_norm), [`warmup_steps`](#optim.warmup_steps), [`decay_steps`](#optim.decay_steps), [`min_lr_ratio`](#optim.min_lr_ratio), [`muon_momentum`](#optim.muon_momentum), [`muon_ns_steps`](#optim.muon_ns_steps), [`muon_nesterov`](#optim.muon_nesterov), [`muon_allow_all_2d`](#optim.muon_allow_all_2d)
