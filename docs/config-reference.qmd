...
|----------|-------|
| Required | No |
| Recommended | `true` when using packing |

::: {.callout-note}
When enabled, attention is restricted within document boundaries in packed sequences,
preventing cross-contamination between documents.
:::
